...
export default function TransactionsPage() {
  ...
  return (
    <>
      <div className="min-h-screen bg-gray-50 dark:bg-slate-900 max-w-2xl mx-auto">
        <div className="p-4 bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-gray-700 pt-16">
