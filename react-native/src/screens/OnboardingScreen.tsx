...
const slides: OnboardingSlide[] = [
  {
    ...
    image: { uri: 'https://ik.imagekit.io/swiftChat/fintrackr/1.webp' },
    bgColor: '#E8F4F8',
    icon: '💰',
  },
  {
    ...
    image: { uri: 'https://ik.imagekit.io/swiftChat/fintrackr/2.webp' },
    bgColor: '#E8F4F8',
    icon: '📊',
  },
  {
    ...
    image: { uri: 'https://ik.imagekit.io/swiftChat/fintrackr/3.webp' },
    bgColor: '#E8F4F8',
    icon: '🎯',
  },
  {
    ...
    image: { uri: 'https://ik.imagekit.io/swiftChat/fintrackr/4.webp' },
    bgColor: '#E8F4F8',
    icon: '🔮',
  },
];
